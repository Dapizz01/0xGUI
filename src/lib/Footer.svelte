...
<footer class="footer grid-cols-2 items-center p-5 bg-neutral text-neutral-content">
    <div class="items-center grid-flow-col">
        <a href="https://github.com/Dapizz01/0xGUI"
            ><svg
    ...
    <div class="grid-flow-col place-self-end justify-self-end">
